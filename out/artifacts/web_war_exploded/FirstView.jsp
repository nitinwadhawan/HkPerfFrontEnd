...
"
    ...
    <script type='text/javascript'>
        ...
        function drawVisualization() {
            ...
            <%
              String getHkAvgTimeByDate="select Avg(load_time) as load_time, create_dt from page_load_performance.response_details a,page_load_performance.response b where a.request_id= b.request_id and a.response_view_type=3 and b.website_id=1 group by Date(create_dt)";
              String getSdAvgTimeByDate="select Avg(load_time) as load_time, create_dt from page_load_performance.response_details a,page_load_performance.response b where a.request_id= b.request_id and a.response_view_type=3 and b.website_id=2 group by Date(create_dt)";
              String getAzAvgTimeByDate="select Avg(load_time) as load_time, create_dt from page_load_performance.response_details a,page_load_performance.response b where a.request_id= b.request_id and a.response_view_type=3 and b.website_id=3 group by Date(create_dt)";
